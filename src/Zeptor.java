...
import xyz.zepton.zeptor.run.control.ZeptorConsole;
...
public final class Zeptor extends MyJFrame implements OpenFileListener, ContainerListener {
    ...
    public Zeptor zeptorFrame = this;
    ...
    private void optionsTheme() {
        try {
            ...
            optionThemeSettingsMenuItem.setToolTipText("Set Look and Feel of Zeptor");
            ...
            bernsteinRadioMenuItem = new JRadioButtonMenuItem("Bernstein");

            bernsteinRadioMenuItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    setLAF(zeptorFrame, ZeptorLAF.BERNSTEIN);
            ...
            liquidRadioMenuItem = new JRadioButtonMenuItem("Liquid");

            liquidRadioMenuItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    setLAF(zeptorFrame, ZeptorLAF.LIQUID);
            ...
            tonicRadioMenuItem = new JRadioButtonMenuItem("Tonic");

            tonicRadioMenuItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    setLAF(zeptorFrame, ZeptorLAF.TONIC);
            ...
            nimbusRadioMenuItem = new JRadioButtonMenuItem("Nimbus");

            nimbusRadioMenuItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    setLAF(zeptorFrame, ZeptorLAF.NIMBUS);

                }//end actionPerformed
            }//end new ActionListener
            );

            lipstikRadioMenuItem = new JRadioButtonMenuItem("Lipstik");

            lipstikRadioMenuItem.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent event) {
                    setLAF(zeptorFrame, ZeptorLAF.LIPSTIK);
            ...
            buttonGroup.add(bernsteinRadioMenuItem);
            ...
            buttonGroup.add(lipstikRadioMenuItem);
            buttonGroup.add(liquidRadioMenuItem);
            ...
            buttonGroup.add(nimbusRadioMenuItem);
            ...
            buttonGroup.add(tonicRadioMenuItem);
            ...
            optionThemeSettingsMenuItem.add(bernsteinRadioMenuItem);
            ...
            optionThemeSettingsMenuItem.add(lipstikRadioMenuItem);
            optionThemeSettingsMenuItem.add(liquidRadioMenuItem);
            ...
            optionThemeSettingsMenuItem.add(nimbusRadioMenuItem);
            ...
            optionThemeSettingsMenuItem.add(tonicRadioMenuItem);
    ...
    private final void setRadioMenuSelected(final ZeptorLAF lafTheme) {
        switch (lafTheme.getIndex()) {
            ...
            case 3:
                this.bernsteinRadioMenuItem.setSelected(true);
                break;
            ...
            case 11:
                this.lipstikRadioMenuItem.setSelected(true);
                break;

            case 12:
                this.liquidRadioMenuItem.setSelected(true);
                break;
            ...
            case 18:
                this.nimbusRadioMenuItem.setSelected(true);
                break;
            ...
            case 25:
                this.tonicRadioMenuItem.setSelected(true);
                break;
    ...
    public void buildMake() {
        ...
        try {
            ...
            final CompilerDialog jcon = new CompilerDialog("Compile ZeptoN Program");

//            final String jdkVersionCompiler = String.format("Build JDK %s - %s %s.%n%n",
...
//            jcon.printf("%s", jdkVersionCompiler);
            ...
            char lastCharPath = outputPath.charAt(outputPath.length() - 1);

            if (lastCharPath == File.separatorChar) {
                sep = "";
            } // end if
    ...
    private void fileNew() {
        ...
        textPane.setText(DEFAULT_ZEPTON_HEADER + DEFAULT_ZEPTON_PROGRAM);
    ...
    /**
     * the previous directory accessed
     */
     ...
     * the editor title
     */
    public static final String TITLE = "Zeptor: ZeptoN Code Editor";
