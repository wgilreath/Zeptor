...
public final class ZepT implements IConfigure {
    ...
    public boolean briefFlag = false;  //set brief error reporting a count of error diagnostics
    public boolean finalFlag = false;  //set final compilation with no debug information
    public boolean panicFlag = false;  //set panic on error and terminate compiler

    public boolean dumpFlag = false;  //set dump raw Java source code to external file
    public boolean echoFlag = false;  //set echo ZeptoN compiler parameters and compiler status
    public boolean hushFlag = false;  //set hush compiler diagnostics except errors
    public boolean muteFlag = false;  //set mute all compiler diagnostics are silenced
    public boolean timeFlag = false;  //set to time overall time to compile a ZeptoN source file
    ...
    public static final String CWD = Zeptor.getOutputPath();   //= System.getProperty("user.dir");
    ...
    public static final String FILE_SOURCE_EXT = ".zept";   //ZeptoN source file extension
    ...
    public static final String VERSION = "Version 2.1 Released June 2021";

    public static final String RELEASE = "ZepC - ZeptoN Echo Transcompiler" + EOL + "Copyright (c) 2021 William F. Gilreath. All Rights Reserved";
     ...
     */
    public void verifyFile(final String filePath) {
    ...
    public JavaSourceCodeStringObject transpileFromFile(final String fileName) {
        ...
        try {
            ...
            javaCodeObject = transpileString(fileName, zepSource);
     ...
     */
    public JavaSourceCodeStringObject transpileString(final String fileName, final String sourceCodeZeptoN) {
            ...
            switch (tok.getImage()) {
                ...
                case "package":
                    ...
                    for (;;) {
                        ...
                        if (tok.getType() != TokenType.SEMICOLON) {
                            ...
                            ZepT.addList(tok.getBeginLine(), list, CODE_HEAD);
                ...
                case "prog":
                    ...
                    if (importFlag) {
                        ...
                        ZepT.addList(idx, list, CODE_HEAD);
